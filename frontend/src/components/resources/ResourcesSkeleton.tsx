const ResourceCardSkeleton = () => {
    return (
        <div  data-testid="resource-card-skeleton" className="flex flex-col w-full py-4 px-4 ring ring-gray-900/5 rounded-2xl shadow-md bg-gray-100">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between animate-pulse">
                ...
                <div className="flex flex-col flex-1 gap-1 mt-2 sm:mt-0">
                    <div className="h-6 w-96 max-w-full rounded bg-gray-300" />
